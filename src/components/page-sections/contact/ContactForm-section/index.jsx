        ...
        <section>
            <div className="container mx-auto max-w-[1440px]">
                <div className='py-[160px]'>
                    ...
                    <div>
                        <h1 className='text-[40px] font-bold text-[#252B42] text-center hidden md:block'>Get in touch</h1>
                        <h1 className='text-[40px] font-bold text-[#252B42] text-center md:hidden'>Contact Us</h1>

                        <p className='text-2xl font-medium text-[#737373] text-center mt-5 hidden md:block'>Most calendars are designed for teams. <br />
                            Slate is designed for freelancers</p>
                        <p className='text-2xl font-medium text-[#737373] text-center mt-5 md:hidden'>Most calendars are <br />
                    ...
                    <div className=' md:flex justify-center items-center gap-x-[27px] mt-[100px] ml-9 md:ml-0'>

                        <div className='flex md:block gap-5 md:gap-0'>
                        ...
                        <div className='flex md:block gap-5 md:gap-0 mt-5 md:mt-0'>
                        ...
                        <div className='flex md:block gap-5 md:gap-0 mt-7 md:mt-0'>
                    ...
                    <div className='flex justify-center'>
                        <div className=' w-[378px] md:w-[868px] h-[685px] md:h-[704px] rounded-[20px] shadow-md border py-[52px] md:px-[80px] mt-[114px] '>
                            <div>
                                <h1 className='text-2xl font-bold text-[#252B42] text-center'>Contact Us</h1>
                            </div>

                            <div className='flex justify-center mt-[45px]'>
                                <input type="text" placeholder='Your Name' className='w-[309px] md:w-[708px] h-[54px] md:h-[64px] bg-[#E6E6E6] pl-[25px] rounded-[10px]' />
                            </div>

                            <div className='flex justify-center mt-[45px]'>
                                <input type="text" placeholder='Your Email' className='w-[309px] md:w-[708px] h-[54px] md:h-[64px] bg-[#E6E6E6] pl-[25px] rounded-[10px]' />
                            </div>

                            <div className='flex justify-center mt-[45px]'>
                                <textarea placeholder='Your Message' className=' w-[295px] md:w-[708px] h-[193px] md:h-[193px] rounded bg-[#E6E6E6] pt-[23px] pl-5'></textarea>
                            </div>

                            <div className=' mt-[45px] ml-10 md:ml-0'>

        ...
        <section className='bg-[#FAFAFA]'>
            <div className="container mx-auto max-w-[1440px]">
                ...
                <div className='py-[120px]'>
                    <h1 className='text-base md:text-2xl font-bold text-center text-[#737373] mb-2'>FAQ</h1>
                    <h1 className='text-[40px] md:text-[58px] font-extrabold text-center text-[#252B42] '>Help</h1>
